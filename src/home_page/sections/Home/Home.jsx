import image from '../../../images/bg_home2.jpg'
const Home = () => {
    
    return (
        <section className="pt-3  lg:pt-10 lg:h-screen lg:overflow-hidden  h-8/12   w-full ">
            <img className="absolute w-full overflow-hidden h-[470px] object-cover  lg:object-top   lg:h-11/12  "  src={image || null} alt="" />
