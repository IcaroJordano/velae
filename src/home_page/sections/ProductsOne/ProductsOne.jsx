...
const ProductsOne = ({ image, title, products }) => {
    ...
    return (
        <section className="">
            ...
            <div className="flex lg:h-full  flex-wrap pt-5  gap-y-10 lg:  lg:px-10 justify-around">
                {products.map((produto,index) => (
                    
                    <CardProduto key={index} image={produto.image} title={produto.title} price={produto.price} />))}
            </div>
